...
// The runtime party-menu option builds all three implementations. Give each a
...
#if defined(PARTY_MENU_VARIANT_BW)
#define PARTY_MENU_VARIANT_NAME(name) PARTY_MENU_VARIANT_JOIN(BwPartyMenu_, name)
#elif defined(PARTY_MENU_VARIANT_HGSS)
#define PARTY_MENU_VARIANT_NAME(name) PARTY_MENU_VARIANT_JOIN(HgssPartyMenu_, name)
...
#define ChangeRotomForm PARTY_MENU_VARIANT_NAME(ChangeRotomForm)
...
#define ItemUseCB_ShinGenome PARTY_MENU_VARIANT_NAME(ItemUseCB_ShinGenome)
...
#define PlayerHasMove PARTY_MENU_VARIANT_NAME(PlayerHasMove)
...
#define SetUpFieldMove_Whirlpool PARTY_MENU_VARIANT_NAME(SetUpFieldMove_Whirlpool)
...
#define Task_ShinGenome PARTY_MENU_VARIANT_NAME(Task_ShinGenome)
...
// Keep the Custom assets on their original public names for non-party users
// (DexNav and battle debug). The DS-style copies are private to each variant.
#if defined(PARTY_MENU_VARIANT_BW) || defined(PARTY_MENU_VARIANT_HGSS)
#define gHeldItemPalette PARTY_MENU_VARIANT_NAME(gHeldItemPalette)
#define gPartyMenuBg_Gfx PARTY_MENU_VARIANT_NAME(gPartyMenuBg_Gfx)
#define gPartyMenuBg_Pal PARTY_MENU_VARIANT_NAME(gPartyMenuBg_Pal)
#define gPartyMenuBg_Tilemap PARTY_MENU_VARIANT_NAME(gPartyMenuBg_Tilemap)
#define gPartyMenuPokeball_Gfx PARTY_MENU_VARIANT_NAME(gPartyMenuPokeball_Gfx)
#define gPartyMenuPokeballSmall_Gfx PARTY_MENU_VARIANT_NAME(gPartyMenuPokeballSmall_Gfx)
#define gPartyMenuPokeball_Pal PARTY_MENU_VARIANT_NAME(gPartyMenuPokeball_Pal)
