...
#define DOME_BATTLE_PARTY_SIZE  FRONTIER_PARTY_SIZE
...
#define BATTLE_DOME_FUNC_GET_OPPONENT_INTRO         23

#define PWT_DOME_TEXT_INTRO        0
#define PWT_DOME_TEXT_PLAYER_WON   1
#define PWT_DOME_TEXT_PLAYER_LOST  2
