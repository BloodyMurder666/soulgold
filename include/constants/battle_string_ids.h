...
enum StringID
{
    ...
    STRINGID_SCORCHEDFIELDSETTLED,
    STRINGID_SUNLIGHTGOTBRIGHT,
    STRINGID_SUNLIGHTSTRONG,
    STRINGID_SUNLIGHTFADED,
    STRINGID_STARTEDHAIL,
    STRINGID_SCORCHEDFIELDSTARTED,
    STRINGID_HAILCONTINUES,
    STRINGID_SCORCHEDFIELDBLAZES,
    STRINGID_TWILIGHTSTARTED,
    STRINGID_TWILIGHTENDED,
    STRINGID_TWILIGHTCONTINUES,
    ...
    STRINGID_BOSSSURGINGWITHPOWER,
    STRINGID_BOSSTRANSFORMED,
    STRINGID_BOSSPHASESURGINGWITHPOWER,
    STRINGID_BOSSPHASETRANSFORMED,
    STRINGID_COUNT
};
...
{
    B_MSG_SET_TRICK_ROOM = (B_MSG_TERRAIN_SET_SCORCHED + 1),
