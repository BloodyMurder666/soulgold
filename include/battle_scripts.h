...
extern const u8 BattleScript_JadeBloomActivates[];
...
extern const u8 BattleScript_FlushStatBuffBatch[];
extern const u8 BattleScript_FlushStatBuffBatchKeepActive[];
...
extern const u8 BattleScript_TitanGripAtkDefDown[];
extern const u8 BattleScript_TitanGripDefSpDefDown[];
...
extern const u8 BattleScript_MendingActivates[];
...
extern const u8 BattleScript_PolarityShiftActivates[];
extern const u8 BattleScript_PowerShiftActivates[];
extern const u8 BattleScript_WishmakerActivates[];
...
extern const u8 BattleScript_HobbleActivates[];
...
extern const u8 BattleScript_WindburstActivates[];
extern const u8 BattleScript_RootedActivates[];
extern const u8 BattleScript_RestoringActivates[];
...
extern const u8 BattleScript_SplinterActivates[];
...
extern const u8 BattleScript_HeatstormActivates[];
...
extern const u8 BattleScript_BattlerAbilityStatRaiseOnSwitchInGeneric[];
extern const u8 BattleScript_GlassCannonActivates[];
extern const u8 BattleScript_RallyActivates[];
extern const u8 BattleScript_TwinStarsActivates[];
extern const u8 BattleScript_DesperadoActivates[];
extern const u8 BattleScript_BloodlustActivates[];
extern const u8 BattleScript_BackdraftActivates[];
...
extern const u8 BattleScript_FillVoidActivates[];
...
extern const u8 BattleScript_ConsumeActivates[];
extern const u8 BattleScript_LifestealActivates[];
extern const u8 BattleScript_SpectralDrainActivates[];
...
extern const u8 BattleScript_InkyActivates[];
extern const u8 BattleScript_FlameburstActivates[];
extern const u8 BattleScript_BrandOfTormentActivates[];
...
extern const u8 BattleScript_TargetAbilityStatRaiseRetSolidify[];
...
extern const u8 BattleScript_ShockwiringActivates[];
extern const u8 BattleScript_OverlockActivates[];
...
extern const u8 BattleScript_EndTurnAbilityLowerStatFoe[];
