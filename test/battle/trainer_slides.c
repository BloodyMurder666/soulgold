...
AI_SINGLE_BATTLE_TEST("Trainer Slide: Singles: Mega Evolution")
{
    GIVEN {
        ...
        PLAYER(SPECIES_WOBBUFFET);
        OPPONENT(SPECIES_LOPUNNY) { Item(ITEM_NORMALITE); Moves(MOVE_CELEBRATE); }
    } WHEN {
...
AI_DOUBLE_BATTLE_TEST("Trainer Slide: Doubles: Mega Evolution")
{
    GIVEN {
        ...
        PLAYER(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_WOBBUFFET);
        OPPONENT(SPECIES_LOPUNNY) { Item(ITEM_NORMALITE); };
...
AI_MULTI_BATTLE_TEST("Trainer Slide: Multi: Mega Evolution")
{
    GIVEN {
        ...
        VAR_SET(TESTING_VAR_TRAINER_SLIDES, TRAINER_SLIDE_MEGA_EVOLUTION);
        MULTI_PLAYER(SPECIES_WOBBUFFET) { Speed(4); }
        MULTI_PARTNER(SPECIES_AERODACTYL) { Speed(2); Item(ITEM_ROCKTITE); }
        MULTI_OPPONENT_A(SPECIES_LOPUNNY) { Speed(3); Item(ITEM_NORMALITE); }
        MULTI_OPPONENT_B(SPECIES_MEDICHAM) { Speed(1); Item(ITEM_FIGHTITE); }
    } WHEN {
        TURN { EXPECT_MOVE(opponentLeft, MOVE_CELEBRATE, gimmick: GIMMICK_MEGA); 
...
AI_SINGLE_BATTLE_TEST("Trainer Slide: Singles: Mega Evolution (Items)")
{
    GIVEN {
        ...
        VAR_SET(TESTING_VAR_TRAINER_SLIDES, TRAINER_SLIDE_MEGA_EVOLUTION);
        PLAYER(SPECIES_WOBBUFFET);
        OPPONENT(SPECIES_LOPUNNY) { Items(ITEM_PECHA_BERRY, ITEM_NORMALITE); Moves(MOVE_CELEBRATE); }
    } WHEN {
        TURN { EXPECT_MOVE(opponent, MOVE_CELEBRATE, gimmick: GIMMICK_MEGA); }
    } SCENE {
        MESSAGE("Trainer A: This message plays before the enemy activates the Mega Evolution gimmick.{PAUSE_UNTIL_PRESS}");
...
AI_DOUBLE_BATTLE_TEST("Trainer Slide: Doubles: Mega Evolution (Items)")
{
    GIVEN {
        ...
        PLAYER(SPECIES_WOBBUFFET);
        PLAYER(SPECIES_WOBBUFFET);
        OPPONENT(SPECIES_LOPUNNY) { Items(ITEM_PECHA_BERRY, ITEM_NORMALITE); };
        OPPONENT(SPECIES_LOPUNNY) { Moves(MOVE_CELEBRATE); }
    } WHEN {
        TURN { EXPECT_MOVE(opponentLeft, MOVE_CELEBRATE, gimmick: GIMMICK_MEGA); }
    } SCENE {
...
AI_MULTI_BATTLE_TEST("Trainer Slide: Multi: Mega Evolution (Items)")
{
    GIVEN {
        ...
        VAR_SET(TESTING_VAR_TRAINER_SLIDES, TRAINER_SLIDE_MEGA_EVOLUTION);
        MULTI_PLAYER(SPECIES_WOBBUFFET) { Speed(4); }
        MULTI_PARTNER(SPECIES_AERODACTYL) { Speed(2); Items(ITEM_PECHA_BERRY, ITEM_ROCKTITE); }
        MULTI_OPPONENT_A(SPECIES_LOPUNNY) { Speed(3); Items(ITEM_PECHA_BERRY, ITEM_NORMALITE); }
        MULTI_OPPONENT_B(SPECIES_MEDICHAM) { Speed(1); Items(ITEM_PECHA_BERRY, ITEM_FIGHTITE); }
    } WHEN {
        TURN { EXPECT_MOVE(opponentLeft, MOVE_CELEBRATE, gimmick: GIMMICK_MEGA); 
            MOVE(playerRight, MOVE_CELEBRATE, gimmick: GIMMICK_MEGA);
            EXPECT_MOVE(opponentRight, MOVE_CELEBRATE, gimmick: GIMMICK_MEGA); }
