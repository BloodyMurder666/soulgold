...
{//   Item                      1+  11+  21+  31+  41+  51+  61+  71+  81+  91+   Levels
    ...
    { ITEM_HEALTH_FEATHER,  {   8,  10,  30,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_MUSCLE_FEATHER,  {   8,  10,   9,  30,   _,   _,   _,   _,   _,   _, } },
    { ITEM_RESIST_FEATHER,  {   3,  10,   9,   _,   _,   _,   _,   _,   _,   _, } },
    { ITEM_GENIUS_FEATHER,  {   3,  10,   9,   9,  30,   _,   _,   _,   _,   _, } },
    { ITEM_CLEVER_FEATHER,  {   3,   3,   9,   8,   9,  30,   _,   _,   _,   _, } },
    { ITEM_REVIVE,          {   3,   3,   3,   8,   8,   9,  30,   _,   _,   _, } },
    { ITEM_HYPER_POTION,    {   3,   3,   3,   4,   8,   9,   8,  30,   _,   _, } },
    { ITEM_SWIFT_FEATHER,   {   1,   1,   3,   4,   4,   _,   _,   _,   _,   _, } },
    ...
    case 1: // calculate experience points to redistribute
        {
            ...
            if (CheckBagHasItem(ITEM_CANDY_JAR, 1))
                GiveCandyJarExp(calculatedExp * 5 / 10);
