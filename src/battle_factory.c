...
{
    // Classic
    {FRONTIER_MON_VENUSAUR_2,     FRONTIER_MONS_HIGH_TIER},   // 110 - 199
    {FRONTIER_MON_VENUSAUR_2, FRONTIER_MONS_HIGH_TIER}, // 162 - 266
    {FRONTIER_MON_VENUSAUR_2, FRONTIER_MONS_HIGH_TIER}, // 267 - 371
    {FRONTIER_MON_VENUSAUR_2,  FRONTIER_MONS_HIGH_TIER},  // 372 - 467
    {FRONTIER_MON_VENUSAUR_2,  FRONTIER_MONS_HIGH_TIER},  // 468 - 563
    {FRONTIER_MON_VENUSAUR_2,  FRONTIER_MONS_HIGH_TIER},  // 564 - 659
    {FRONTIER_MON_VENUSAUR_2,  FRONTIER_MONS_HIGH_TIER},  // 660 - 755
    {FRONTIER_MON_VENUSAUR_2,  FRONTIER_MONS_HIGH_TIER}, // 372 - 849

    // Chaos
    {FRONTIER_MON_VENUSAUR_2, FRONTIER_MON_TATSUGIRI_1}, // 372 - 467
    {FRONTIER_MON_VENUSAUR_2, FRONTIER_MON_TATSUGIRI_1}, // 468 - 563
    {FRONTIER_MON_VENUSAUR_2, FRONTIER_MON_TATSUGIRI_1}, // 564 - 659
    {FRONTIER_MON_VENUSAUR_2, FRONTIER_MON_TATSUGIRI_1}, // 660 - 755
    {FRONTIER_MON_VENUSAUR_2, NUM_FRONTIER_MONS - 1},  // 372 - 881
    {FRONTIER_MON_VENUSAUR_2, NUM_FRONTIER_MONS - 1},  // 372 - 881
    {FRONTIER_MON_VENUSAUR_2, NUM_FRONTIER_MONS - 1},  // 372 - 881
    {FRONTIER_MON_VENUSAUR_2, NUM_FRONTIER_MONS - 1},  // 372 - 881
};
