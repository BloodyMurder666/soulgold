...
static const u8 sDoorAnimTiles_JohtoSafariZone_Door[] = INCBIN_U8("graphics/door_anims/johtosafari_zone.4bpp");
...
static const u8 sDoorAnimPalettes_GeneralJohto[] = {2, 2, 2, 2, 2, 2, 2, 2};
...
static const u8 sDoorAnimPalettes_NewBarkTown_Door_Yellow[] = {10, 10, 10, 10, 10, 10, 10, 10};
...
static const u8 sDoorAnimPalettes_EcruteakCity_Dojo_Door[] = {7, 7, 7, 7, 7, 7, 7, 7};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_Johto_General_Door,                           DOOR_SOUND_NORMAL,  DOOR_SIZE_1x1, sDoorAnimTiles_GeneralJohto, sDoorAnimPalettes_GeneralJohto},
