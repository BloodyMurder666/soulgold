...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_TORTERRA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_OVERGROW, ABILITY_NONE, ABILITY_SHELL_ARMOR },
        .innates = { ABILITY_PLANTATION, ABILITY_STAMINA, ABILITY_SOLID_ROCK },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_LOPUNNY] =
    {
        ...
        .innates = { ABILITY_FIGHTER_SOUL, ABILITY_FUR_COAT, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LOPUNNY_MEGA] =
    {
        ...
        .innates = { ABILITY_ADRENALINE, ABILITY_STEEL_FEET, ABILITY_IRON_FIST },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Lopunny"),
    #if P_MODIFIED_MEGA_CRIES
...
#define ROTOM_FAMILY_TYPES { TYPE_ELECTRIC, TYPE_GHOST }
    ...
    [SPECIES_DARKRAI] =
    {
        ...
        .innates = { ABILITY_NIGHT_STALKER, ABILITY_CURSED_BODY, ABILITY_LEVITATE },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
...
#define ARCEUS_SPECIES_INFO(type, typeName, iconPal)                                \
    {                                                                               \
        ...
        .innates = { ABILITY_PROTEAN, ABILITY_AURA_SHIELD, ABILITY_AIR_LOCK },                                                               \
        .bodyColor = BODY_COLOR_WHITE,                                              \
