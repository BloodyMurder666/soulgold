...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_MEOWSCARADA_MEGA] =
    {
        ...
        .innates = { ABILITY_LEAF_GUARD, ABILITY_ABYSSAL_VEIL, ABILITY_MAIM_AND_MEND },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Meowscarada"),
        .cryId = CRY_MEOWSCARADA,
        .natDexNum = NATIONAL_DEX_MEOWSCARADA,
    ...
    [SPECIES_KORAIDON] =
    {
        ...
        .innates = { ABILITY_INNER_FOCUS, ABILITY_ANGER_POINT, ABILITY_DEFIANT },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_MIRAIDON] =
    {
        ...
        .innates = { ABILITY_STATIC, ABILITY_BATTLE_ARMOR, ABILITY_VOLT_ABSORB },
        .bodyColor = BODY_COLOR_PURPLE,
