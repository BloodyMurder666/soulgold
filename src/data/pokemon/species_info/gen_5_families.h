...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_COFAGRIGUS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_MUMMY, ABILITY_NONE, ABILITY_NONE },
        .innates = { ABILITY_FILL_VOID, ABILITY_HAUNTING, ABILITY_CURSED_BODY },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_RUNERIGUS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_WANDERING_SPIRIT, ABILITY_NONE, ABILITY_NONE },
        .innates = { ABILITY_FILL_VOID, ABILITY_EARTHBOUND, ABILITY_SPECTRAL_DRAIN },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
    ...
    [SPECIES_GOLURK_MEGA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_IRON_FIST, ABILITY_KLUTZ, ABILITY_NO_GUARD },
        .innates = { ABILITY_UNSEEN_FIST, ABILITY_SPECTRAL_DRAIN, ABILITY_MYSTIC_FORCE },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
        .speciesName = _("Golurk"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_ZEKROM] =
    {
        ...
        .innates = { ABILITY_OVERLOAD, ABILITY_DRACONIC_REFLEX, ABILITY_HOBBLE },
        .bodyColor = BODY_COLOR_BLACK,
