...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_TYPHLOSION] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_NONE, ABILITY_FLASH_FIRE },
        .innates = { ABILITY_FLAME_BODY, ABILITY_BERSERK, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_TYPHLOSION_MEGA] =
    {
        ...
        .innates = { ABILITY_SOLAR_POWER, ABILITY_FLAME_BODY, ABILITY_BERSERK },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Typhlosion"),
        .cryId = CRY_TYPHLOSION,
        .natDexNum = NATIONAL_DEX_TYPHLOSION,
    ...
    [SPECIES_TYPHLOSION_HISUI] =
    {
        ...
        .innates = { ABILITY_FLAME_BODY, ABILITY_CURSED_BODY, ABILITY_SOUL_HEART },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Typhlosion"),
        .cryId = CRY_TYPHLOSION,
        .natDexNum = NATIONAL_DEX_TYPHLOSION,
    ...
    [SPECIES_NOCTOWL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_INSOMNIA, ABILITY_KEEN_EYE, ABILITY_TINTED_LENS },
        .innates = { ABILITY_FOREWARN, ABILITY_MAGIC_GUARD, ABILITY_SHADOW_SHIELD },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_ARIADOS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_INSOMNIA, ABILITY_SNIPER },
        .innates = { ABILITY_STAKEOUT, ABILITY_MERCILESS, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_LANTURN] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_ILLUMINATE, ABILITY_WATER_ABSORB },
        .innates = { ABILITY_HYDRATION, ABILITY_DAZZLING, ABILITY_BATTERY },
        .bodyColor = BODY_COLOR_BLUE,
...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_XATU] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_EARLY_BIRD, ABILITY_MAGIC_BOUNCE },
        .innates = { ABILITY_FOREWARN, ABILITY_MAGIC_GUARD, ABILITY_COMPETITIVE },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Xatu"),
        .cryId = CRY_XATU,
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_STATIC, ABILITY_NONE, ABILITY_PLUS },
        .innates = { ABILITY_FLUFFY, ABILITY_COTTON_DOWN, ABILITY_GALVANIZE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_AMPHAROS_MEGA] =
    {
        ...
        .innates = { ABILITY_FLUFFY, ABILITY_TRANSISTOR, ABILITY_DRAGONS_MAW },
        .bodyColor = BODY_COLOR_YELLOW,
        .speciesName = _("Ampharos"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_AZUMARILL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_THICK_FAT, ABILITY_HUGE_POWER, ABILITY_SAP_SIPPER },
        .innates = { ABILITY_CHEEK_POUCH, ABILITY_WATER_VEIL, ABILITY_WATER_BUBBLE },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_AMBIPOM] =
    {
        ...
        .innates = { ABILITY_PICKPOCKET, ABILITY_LONG_REACH, ABILITY_PARENTAL_BOND },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_MISMAGIUS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE },
        .innates = { ABILITY_CURSED_BODY, ABILITY_MAGIC_GUARD, ABILITY_SHADOW_SHIELD },
        .bodyColor = BODY_COLOR_PURPLE,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_FARIGIRAF] =
    {
        ...
        .innates = { ABILITY_FOREWARN, ABILITY_INNER_FOCUS, ABILITY_PSYCHIC_SURGE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .innates = { ABILITY_SIMPLE, ABILITY_MAGIC_GUARD },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_DUDUNSPARCE_TWO_SEGMENT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_RUN_AWAY, ABILITY_RATTLED },
        .innates = { ABILITY_SIMPLE, ABILITY_MAGIC_GUARD, ABILITY_STAKEOUT },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .innates = { ABILITY_TOUGH_CLAWS, ABILITY_TECHNICIAN, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_SNEASLER] =
    {
        ...
        .innates = { ABILITY_TOUGH_CLAWS, ABILITY_MERCILESS, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_SNOW_CLOAK, ABILITY_THICK_FAT },
        .innates = { ABILITY_SLUSH_RUSH, ABILITY_STAMINA },
    #else
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_NONE, ABILITY_THICK_FAT },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_MAMOSWINE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_SNOW_CLOAK, ABILITY_THICK_FAT },
        .innates = { ABILITY_SLUSH_RUSH, ABILITY_STAMINA, ABILITY_SNOW_WARNING },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .innates = { ABILITY_WATER_COMPACTION, ABILITY_PASTEL_VEIL },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_CORSOLA_GALAR] =
    {
        ...
        .innates = { ABILITY_WANDERING_SPIRIT, ABILITY_PERISH_BODY },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Corsola"),
        .cryId = CRY_CORSOLA,
        .natDexNum = NATIONAL_DEX_CORSOLA,
    ...
    [SPECIES_CURSOLA] =
    {
        ...
        .innates = { ABILITY_CURSED_BODY, ABILITY_SOUL_HEART, ABILITY_SHADOW_SHIELD },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_MANTINE] =
    {
        ...
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_WATER_ABSORB, ABILITY_WATER_VEIL },
        .innates = { ABILITY_HYDRATION, ABILITY_WATER_BUBBLE, ABILITY_FILTER },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SKARMORY] =
    {
        ...
        .innates = { ABILITY_BATTLE_ARMOR, ABILITY_MIRROR_ARMOR, ABILITY_STEELWORKER },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_SKARMORY_MEGA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_STURDY, ABILITY_WEAK_ARMOR },
        .innates = { ABILITY_TOUGH_CLAWS, ABILITY_MIRROR_ARMOR, ABILITY_STEELWORKER },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Skarmory"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_HOUNDOOM_MEGA] =
    {
        ...
        .innates = { ABILITY_FLASH_FIRE, ABILITY_DARK_AURA, ABILITY_BERSERK },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Houndoom"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .innates = { ABILITY_SAND_RUSH, ABILITY_STAMINA, ABILITY_SAND_STREAM },
        .bodyColor = BODY_COLOR_GRAY,
