...
{
    {FORM_CHANGE_NICKNAME, SPECIES_LUGIA_SHADOW, FORM_CHANGE_NICKNAME_XD001, FORM_CHANGE_NICKNAME_EQUALS,     MOVE_AEROBLAST, MOVE_DARK_AERO},
    {FORM_CHANGE_NICKNAME, SPECIES_LUGIA,        FORM_CHANGE_NICKNAME_XD001, FORM_CHANGE_NICKNAME_NOT_EQUALS, MOVE_DARK_AERO, MOVE_AEROBLAST},
    {FORM_CHANGE_TERMINATOR},
};
