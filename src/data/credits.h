...
//HnS Port
static const struct CreditsEntry sCreditsEntry_Porter       = {11, TRUE, sCreditsText_Porter};
static const struct CreditsEntry sCreditsEntry_IAmAwesome2       = {11, FALSE, sCreditsText_IAmAwesome2};
