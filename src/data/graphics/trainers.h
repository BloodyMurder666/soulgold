...
const u16 gTrainerPaletteBurglar[] = INCBIN_U16("graphics/trainers/front_pics/burglar.gbapal.lz");
...
const u32 gTrainerFrontPic_LeaderPryce[] = INCBIN_U32("graphics/trainers/front_pics/pryce_2.4bpp.smol");
